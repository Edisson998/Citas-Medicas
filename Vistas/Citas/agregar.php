    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                ...
                <form  novalidate enctype="multipart/form-data" id="formCita" name="formuCita" method="POST">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control input paciente" id="Paciente" name="Paciente">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary  btn-sm" data-dismiss="modal"><i class="fa fa-close" aria-hidden="true"></i> Cerrar</button>
                <br>
                <button type="button" onclick="validarFormulario();" class="btn btn-primary btn-sm" name="btnAgregarCita" id="btnAgregarCita"><i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar</button>
