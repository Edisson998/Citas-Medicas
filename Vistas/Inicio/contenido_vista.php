...
<body>
  ...
  <div>
    <br><br>
    <strong>
      <h1 class="mensaje"> .:M E D I &nbsp;&nbsp; C E N T E R:.</h1>
    </strong>
  </div>
    ...
    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
      <div class="tile-stats">
        ...
        <div class="count"><?php
                            ...
                            $cita_agendada  = $result->fetchColumn();
                            echo $cita_agendada
                            ?></div>
        <h3>Citas</h3>
        <h3>Agendadas</h3>
    ...
    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
      <div class="tile-stats">
        ...
        <div class="count"><?php
                            ...
                            $result = $co->query($sql); //$pdo sería el objeto conexión
                            $citas_atendidas = $result->fetchColumn();
                            echo $citas_atendidas
                            ?></div>
        <h3>Citas </h3>
        <h3>Atendidas</h3>
    ...
    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
      <div class="tile-stats">
        ...
        <div class="count"><?php
                            ...
                            $result = $co->query($sql); //$pdo sería el objeto conexión
                            $citas_no_atendidas = $result->fetchColumn();
                            echo $citas_no_atendidas ?></div>
        <h3>Citas No</h3>
        <h3>Atendidas</h3>
    ...
    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
      <div class="tile-stats">
        ...
        <div class="count"><?php
                            ...
                            $result = $co->query($sql); //$pdo sería el objeto conexión
                            $medicos_disponibles = $result->fetchColumn();
                            echo $medicos_disponibles
                            ?></div>
        <h3>Medicos</h3>
        <h3>Disponibles</h3>
